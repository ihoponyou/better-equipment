...
local useEventConnection = require(ReplicatedStorage.Shared.useEventConnection)
local EquipmentSlot = require(ReplicatedStorage.Shared.UIElements.EquipmentSlot)
